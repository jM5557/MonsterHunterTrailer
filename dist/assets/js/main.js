...
$(document).ready(function(){
	...
	$(".video_container .el_container").click(function(){
		...
		$("body").append('<div id = "video_overlay"><span id = "close_video_modal">&#10006;</span></div>');

		$("#video_overlay").append("<iframe src=\"https://www.youtube.com/embed/" + vid_url + "?autoplay=1\" frameborder=\"0\" allowfullscreen ></iframe>");
		$("#video_overlay, #close_video_modal").click(function () {
